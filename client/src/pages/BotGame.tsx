  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-800 via-green-700 to-green-900 p-4 flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col justify-between">
        <div className="mb-6">
          ...
          <div className="flex justify-center gap-1 flex-wrap max-w-lg mx-auto">
            {gameState.botHand.map((_, index) => (
              <div
                key={index}
                className="w-14 h-20 bg-gradient-to-br from-red-600 via-red-500 to-red-700 rounded-lg border-2 border-red-800 shadow-lg flex items-center justify-center"
              >
                <span className="text-white font-bold text-[10px] transform -rotate-12">UNO</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="flex justify-center items-end gap-6 my-6 -ml-20">
          {/* Draw deck - left side */}
          <div className="text-center">
            ...
            >
              <span className="text-white font-bold text-[10px] transform -rotate-12 drop-shadow-lg">DRAW</span>
            </button>
          ...
          {/* Played card - center, same size as player cards */}
          <div className="text-center">
            {topCard && (
