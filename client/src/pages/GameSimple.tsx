...
import { Menu, ArrowRight, ArrowLeft, Users } from "lucide-react";
            ...
            <div className="w-28 h-28 sm:w-32 sm:h-32 md:w-40 md:h-40 lg:w-48 lg:h-48 rounded-full bg-gradient-to-br from-yellow-200 to-orange-300 shadow-inner flex items-center justify-center relative border-2 border-white/50">
              ...
              <div className="flex flex-col items-center">
                <div className="w-12 h-16 sm:w-16 sm:h-20 md:w-20 md:h-28 bg-gradient-to-br from-red-500 to-red-700 rounded-lg border-2 border-white shadow-xl flex items-center justify-center">
                  <div className="text-white font-bold text-xs sm:text-sm md:text-base">7</div>
                </div>
              </div>
              ...
              <div className="absolute -right-6 sm:-right-8 md:-right-12 top-1/2 transform -translate-y-1/2">
                ...
                <div className="text-xs text-center mt-1 text-white font-bold">CW</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-wrap gap-1 sm:gap-2 justify-center max-h-24 sm:max-h-32 md:max-h-40 overflow-y-auto">
              {currentPlayer.hand?.map((card: any, index: number) => (
                <div key={index} className="flex-shrink-0">
                  <div className="w-8 h-12 sm:w-10 sm:h-14 md:w-12 md:h-16 bg-gradient-to-br from-red-500 to-red-700 rounded border border-white shadow-sm flex items-center justify-center cursor-pointer hover:scale-105 transition-transform">
